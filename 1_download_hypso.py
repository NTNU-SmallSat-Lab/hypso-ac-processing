...
#csv_file_path = os.path.join(script_dir, "config", "captures_aeronet_oc_h2.csv") # for the AOC stuff
csv_file_path = os.path.join(script_dir, "config", "captures_snr_1.csv") # for the SNR stuff
